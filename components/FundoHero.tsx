  ...
  return (
    <div className="min-h-dvh bg-brand-bg">
      <section className="relative flex min-h-dvh flex-col items-center justify-center overflow-hidden bg-brand-navy px-4 py-6 text-center sm:py-10">
        ...
        <div className="absolute inset-x-4 top-[38px] z-20 sm:top-[92px]">
          <div className="mx-auto grid max-w-[960px] grid-cols-3 items-center">
            ...
            <div className="flex justify-center">
              <img src="/consulte.svg" alt="Consulte" className="h-9 w-auto sm:h-16" />
            </div>
            <div />
          </div>
        </div>

        <div className="relative z-10 flex w-full max-w-[960px] flex-col items-center pt-16 sm:pt-28">
          {children}
        </div>
